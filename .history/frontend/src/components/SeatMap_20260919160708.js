...
<main 
  ref={canvasRef}
  className={`${seatMapCanvasArea} flex-1 relative overflow-auto bg-zinc-800 printable-canvas-area h-full flex`}
...
>
  {/* Replaces absolute top-1/2 with flex m-auto and generous padding to allow full 360 scrolling */}
  <div 
    className="m-auto p-20 flex items-center justify-center shrink-0"
    style={{
      width: `${(activePage.width * (zoomLevel / 100)) + 160}px`,
      height: `${(activePage.height * (zoomLevel / 100)) + 160}px`
    }}
  >
    <div 
