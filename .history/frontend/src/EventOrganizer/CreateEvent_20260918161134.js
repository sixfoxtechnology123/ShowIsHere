        ...
        <div className="border-b border-slate-100"></div>
          ...
          {activeStep === 6 && (
            <div className="space-y-6">
              ...
              <div className=" bg-amber-50 border border-amber-200 rounded-md flex items-center justify-center gap-2 text-xs text-amber-700 font-medium absolute w-3/5 p p-3">
