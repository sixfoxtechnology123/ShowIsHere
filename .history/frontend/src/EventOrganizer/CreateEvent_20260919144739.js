                  ...
                  {isLast && (
                    <button 
                      ...
                      onClick={() => {
                        ...
                        className="w-9 h-8 rounded-lg bg-blue-50 text-blue-600 hover:bg-blue-100 flex items-center justify-center font-bold text-base cursor-pointer transition"
                      title="Add time slot"
                    >
                      +
                    </button>
