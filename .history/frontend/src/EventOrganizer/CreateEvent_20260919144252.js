                ...
                return (
                  ...
                  >
                    ...
                    <button
                      ...
                      className="absolute -top-2.5 -right-2.5 w-4 h-4 rounded-full bg-rose-100 text-rose-500 hover:bg-rose-200 hover:text-rose-700 flex items-center justify-center font-bold text-xs cursor-pointer shadow-sm opacity-0 group-hover:opacity-100 transition-all duration-150 transform scale-90 group-hover:scale-100"
                      title="Remove date"
                    >
