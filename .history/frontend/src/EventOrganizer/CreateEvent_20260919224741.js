...
<div className="space-y-4">
  <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
    ...
    <div className="lg:col-span-5 flex flex-col gap-2 justify-center pt-28">
      <Link 
        to="/seatmap" 
        className="w-16 py-2 px-1 bg-blue-600 hover:bg-blue-700 text-white text-sm font-semibold rounded-xl text-center no-underline shadow-xs transition cursor-pointer"
      >
