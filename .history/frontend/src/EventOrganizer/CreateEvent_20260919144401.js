            ...
            <div className="flex flex-wrap gap-3 pt-2 w-full">
              {formData.selectedWeeklyDates.map((dateStr, i) => {
                ...
                return (
                  <div 
                    key={i} 
                    className="relative group px-5 py-2.5 bg-blue-600 text-white rounded-lg text-xs font-bold shadow-xs inline-flex items-center justify-center select-none"
                  >
                    <span>{formatted}</span>
