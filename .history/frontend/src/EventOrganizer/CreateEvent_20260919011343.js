...
<div className="pt-6 border-t border-slate-100 space-y-4 w-full">
  ...
  <div className="flex flex-col gap-6 w-full">
    ...
    {/* Location Map Container (Height increased to h-96, clean view without extra icons or top-left box) */}
        ...
        {formData.venueName || formData.venueAddress || formData.venueCity || formData.venuePinCode ? (
          <iframe
            ...
            src={(() => {
              ...
              // &iwloc= removes the white place detail card from the top-left inside the map
              return `https://maps.google.com/maps?q=${encodeURIComponent(query)}&t=m&z=${zoomLevel}&iwloc=&output=embed`;
            })()}
          ></iframe>
        ) : (
