...
<div className="flex flex-col xl:flex-row gap-8 items-start justify-center">
  {/* Left Column: Fixed 750px Width Unit with Zoom Controls on Top */}
  <div className="w-[750px] shrink-0 flex flex-col items-center">
    
    {/* ZOOM CONTROLS (OUTSIDE TOP ONLY) */}
    {seatMapImage && (
      <div className="w-[750px] flex items-center justify-between pb-2 px-1">
        <span className="text-[11px] font-bold text-slate-500 uppercase tracking-wider">
          Layout Canvas (750 × 600 px)
        </span>
    ...
    {/* EXACT 750px WIDTH × 600px HEIGHT BOX (NO FOOTER) */}
    <div
      ...
      style={{ width: '550px', height: '00px' }}
      className={`border-2 border-slate-300 rounded-2xl relative flex items-center justify-center overflow-hidden transition bg-slate-100 shadow-md shrink-0 ${
        seatMapImage
          ? isDraggingImg
    ...
    >
      {seatMapImage ? (
        ...
        <div className="p-8 text-center text-slate-400">
          ...
          <span className="text-sm font-semibold block text-slate-700">750 × 600 px Seating Canvas</span>
  ...
  <div className="flex flex-col gap-3 w-full max-w-sm pt-8">
    ...
    <div className="p-3 bg-blue-50/60 border border-blue-100 rounded-xl flex items-start gap-2.5 mt-2">
      ...
      <p className="text-[11px] text-slate-600 leading-relaxed">
        Canvas viewport is locked to <strong>750px width × 600px height</strong> with drag-to-pan and zoom controls.
      </p>
    </div>
  </div>
</div>
