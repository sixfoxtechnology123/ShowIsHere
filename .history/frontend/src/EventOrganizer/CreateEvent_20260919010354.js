...
<div className="pt-6 border-t border-slate-100 space-y-4 w-full">
  ...
  <div className="flex items-center justify-between">
    ...
    <span className="text-[11px] text-slate-400">💡 Drag the red pin or click anywhere on the map to set exact spot</span>
  </div>
  ...
  <div className="border-2 border-slate-200 rounded-2xl h-96 bg-slate-100 relative overflow-hidden shadow-xs w-full z-0">
    <MapContainer
      ...
      zoom={15}
      scrollWheelZoom={true} // Direct mouse-wheel zoom (No Ctrl required)
    ...
    >
      ...
      <MapRecenter center={[mapCoords.lat, mapCoords.lng]} />
      ...
      <Marker
        ...
        eventHandlers={{
          dragend: (e) => {
            ...
            // Save the exact dragged coordinates into formData
            setFormData(prev => ({ ...prev, venueGoogleMapLink: `${position.lat},${position.lng}` }));
          }
        }}
      />
    </MapContainer>
