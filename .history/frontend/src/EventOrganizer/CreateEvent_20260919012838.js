...
{/* Google Map View with Custom + / - Zoom Controls */}
      ...
      <>
        <iframe
          ...
          src={(() => {
            ...
            return `https://maps.google.com/maps?q=${encodeURIComponent(query)}&z=${mapZoom}&t=m&iwloc=near&output=embed`;
          })()}
        ></iframe>

        {/* Floating + and - Custom Zoom Controls */}
        <div className="absolute right-3 top-3 flex flex-col shadow-md rounded-xl overflow-hidden z-20 bg-white border border-slate-200">
          <button
            ...
            className="w-9 h-9 bg-white hover:bg-slate-50 flex items-center justify-center text-slate-800 font-bold text-lg border-b border-slate-100 cursor-pointer transition select-none"
            title="Zoom in"
          >
            +
          </button>
          <button
            ...
            className="w-9 h-9 bg-white hover:bg-slate-50 flex items-center justify-center text-slate-800 font-bold text-lg cursor-pointer transition select-none"
            title="Zoom out"
          >
            −
          </button>
