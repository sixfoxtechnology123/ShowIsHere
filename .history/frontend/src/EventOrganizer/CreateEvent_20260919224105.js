...
<div className="space-y-4">
  <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
    ...
    <div className="lg:col-span-5 flex flex-col gap-3 justify-center pt-8">
      ...
      <label className="w-full py-3.5 px-3 bg-white border-2 border-slate-200 hover:border-slate-300 text-slate-800 text-sm font-semibold rounded-xl text-center cursor-pointer shadow-xs transition block">
        Upload image
        <input 
          type="file" 
          accept="image/*" 
