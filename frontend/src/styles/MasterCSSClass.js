...
export const locationButton = "flex items-center space-x-1 text-sm font-medium text-slate-700 bg-slate-100 hover:bg-slate-200 px-3 py-1.5 rounded-lg transition border border-slate-200";
...
export const zoomToolbar = "absolute top-4 right-6 bg-white border border-slate-200 rounded-xl px-3 py-1.5 flex items-center space-x-3 shadow-xs z-20 text-sm";
...
export const sidebarToggleBtn = "bg-slate-100 hover:bg-slate-200 text-slate-700 text-sm font-bold px-3 py-2 rounded-xl transition cursor-pointer border border-slate-200 flex items-center space-x-1.5";
...
export const artistInputStyle = "w-full bg-slate-50 border border-slate-300 rounded-xl px-2.5 py-1 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 font-medium";
export const artistTextareaStyle = "w-full bg-slate-50 border border-slate-300 rounded-xl px-2.5 py-1 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 font-medium resize-none";
...
export const artistSearchInputCenter = "w-full bg-slate-50 border border-slate-300 rounded-xl px-3 py-1 text-sm font-medium text-center focus:outline-none";
...
export const wizardIfscFetchBtn = "px-4 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-bold text-sm rounded-xl shadow-xs transition cursor-pointer whitespace-nowrap";
...
export const wizardProceedBtn = "px-6 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl text-sm transition cursor-pointer shadow-sm";
// ==========================================
...
export const accountStepItemInactive = "flex items-center space-x-3 px-5 py-2 rounded-xl text-sm font-semibold text-slate-400 cursor-pointer hover:text-slate-600 transition";
...
export const accountSecondaryBtn = "px-6 py-2.5 bg-white hover:bg-slate-50 text-slate-700 border border-slate-300 font-bold text-sm rounded-xl transition cursor-pointer shadow-2xs";
...
export const accountUploadBtn = "px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-bold text-sm rounded-xl transition cursor-pointer shadow-sm";
...
export const gstModalBody = "overflow-y-auto space-y-2 text-sm text-slate-600 font-medium leading-relaxed pr-2 border border-slate-200 bg-slate-50/40 p-2 rounded-xl flex-1 my-3";
...
export const gstModalProceedBtn = "px-6 py-1.5 bg-blue-600 text-white font-bold text-sm rounded-xl transition cursor-pointer shadow-sm disabled:bg-slate-200 disabled:text-slate-400 disabled:cursor-not-allowed";
...
export const sigCancelBtn = "px-4 py-2 text-sm font-bold text-slate-600 hover:bg-slate-100 rounded-xl transition cursor-pointer border border-slate-200";
export const sigClearBtn = "px-4 py-2 text-sm font-bold text-slate-600 hover:bg-slate-100 rounded-xl transition cursor-pointer border border-slate-200";
export const sigSaveBtn = "px-5 py-2 text-sm font-bold text-white bg-blue-600 hover:bg-blue-700 rounded-xl transition shadow-sm cursor-pointer";
...
export const dashCreateEventBtn = "inline-flex items-center justify-center space-x-2 px-5 py-2.5  text-blue-600 font-bold text-sm rounded-xl shadow-md shadow-blue-600/20 transition cursor-pointer mt-4";
...
export const dashStatDropdownBtn = "text-slate-400 hover:text-slate-600 text-sm font-medium flex items-center space-x-1 bg-slate-50 px-2.5 py-1 rounded-lg border border-slate-200 cursor-pointer";
...
export const dashSearchInputBox = "w-full sm:w-64 bg-slate-50 border border-slate-200 rounded-xl px-3.5 py-2 text-sm font-medium text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500";
export const dashFilterDropdownBtn = "flex items-center space-x-2 bg-slate-50 hover:bg-slate-100 text-slate-700 text-sm font-semibold px-3.5 py-2 rounded-xl border border-slate-200 transition cursor-pointer";

export const dashTableContainer = "overflow-x-auto";
export const dashTableStyled = "w-full text-left border-collapse text-sm whitespace-nowrap";
...
export const dashSidebarDateRow = "flex items-center space-x-1.5 text-sm text-slate-400 mt-1";
...
export const paychequeSearchInput = "w-full bg-white border border-slate-200 rounded-none px-8 py-2 text-sm text-slate-800 focus:outline-none focus:ring-1 focus:ring-blue-500";
export const paychequeSearchIcon = "absolute left-3 top-2.5 text-slate-400";
export const paychequeDropdownBtn = "bg-white border border-slate-200 px-4 py-2 text-sm font-semibold text-slate-700 flex items-center space-x-4 rounded-none cursor-pointer";
...
export const paychequePageBtn = "w-7 h-7 rounded-none border border-slate-200 text-slate-400 flex items-center justify-center text-sm";
...
export const reportDropdownButton = "bg-white border-2 border-purple-300 px-4 py-2 text-sm font-bold text-purple-900 flex items-center justify-between space-x-6 rounded-md shadow-xs cursor-pointer";
