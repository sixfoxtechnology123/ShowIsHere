...
export const navbar = "bg-white text-slate-800 px-6 py-3 h-14 flex items-center justify-between border-b border-slate-200/80 sticky top-0 z-50 shadow-xs";
...
export const heroTierCardActive = "border border-blue-600 bg-blue-50/40 ring-1 ring-blue-600 rounded-md p-3 text-left transition cursor-pointer relative";
export const heroTierCardInactive = "border-2 border-slate-200 hover:border-slate-300 rounded-md p-3 text-left transition cursor-pointer relative";
export const heroTierName = "text-sm font-bold text-slate-700 block mb-1";
...
export const seatSelectorBox = "flex items-center space-x-3 bg-slate-50 border-2 border-slate-200 px-4 py-2 rounded-md text-sm font-bold text-slate-800";
...
export const detailsButton = "bg-white hover:bg-slate-50 text-slate-700 border border-slate-300 font-semibold px-6 py-3 rounded-md transition text-sm";
...
export const searchBarInner = "relative flex items-center border border-slate-300 rounded-md px-4 py-1 bg-white shadow-xs focus-within:ring-1 focus-within:ring-[#415FCF] focus-within:border-transparent";
...
export const otherCitiesGridMulti = "grid grid-cols-2 sm:grid-cols-5 gap-x-4 text-sm text-slate-600 max-h-48 overflow-y-auto pr-2";
...
export const salesBadge = "text-sm font-semibold text-emerald-600 bg-emerald-50 px-2.5 py-1 rounded-md";
export const redSticker = "absolute top-3 left-3 bg-red-600 text-white text-sm font-bold px-2.5 py-1 rounded-md shadow-md z-10";
export const trendingBadge = "absolute top-3 right-3 bg-amber-500 text-white text-sm font-bold px-2.5 py-1 rounded-md shadow-md z-10";
...
export const footerTopBar = "bg-[#1f242d] text-white py-2 px-6 flex flex-col sm:flex-row items-center justify-around text-sm font-medium tracking-wide";
...
export const footerHeading = "text-sm font-bold text-slate-400 tracking-widest mb-2";
export const footerLinkList = "space-y-1 text-sm text-slate-600";
export const footerLinkItem = "hover:text-blue-600 font-semibold cursor-pointer transition py-0.5";
export const footerBottomBar = "mt-3 pt-2 pb-4 flex flex-col md:flex-row items-center justify-between text-sm text-slate-500 relative z-10";
export const footerSocialIcons = "flex items-center space-x-3 my-2 md:my-0";
export const socialCircleBtn = "w-7 h-7 rounded-full border border-slate-600 flex items-center justify-center hover:bg-slate-900 hover:text-white hover:border-slate-900 transition text-slate-800 cursor-pointer text-sm font-bold shadow-2xs";
...
export const aboutStatLabel = "text-sm font-bold text-slate-400 tracking-widest";
...
export const seatMapSidebar = "w-48 bg-white border-r border-slate-200 p-4 overflow-y-auto flex flex-col space-y-6 shrink-0 text-sm";
...
export const zoomToolbar = "absolute top-4 right-6 bg-white border-2 border-slate-200 rounded-md px-3 py-1.5 flex items-center space-x-3 shadow-xs z-20 text-sm";
export const canvasBoard = "w-[2000px] h-[2000px] bg-white rounded-3xl shadow-xl border-2 border-slate-200 relative overflow-hidden transition-transform duration-150 absolute top-0 left-0 right-0 bottom-0";
...
export const stageBox = "absolute top-1 left-1/2 transform -translate-x-1/2 bg-white text-slate-800 rounded-2xl flex items-center justify-center font-extrabold text-sm tracking-widest shadow-sm border border-slate-300";
export const sectionCard = "absolute bg-white/95 backdrop-blur-xs border-2 rounded-2xl 2-4 shadow-lg transition-shadow cursor-move";
export const propertiesSidebar = "w-64 bg-white border-l border-slate-200 p-6 overflow-y-auto shrink-0 space-y-5 text-sm z-30 max-h-[120vh]";
export const seatMapFooter = "bg-white border-t border-slate-200 px-6 py-2.5 flex items-center justify-between text-sm font-medium text-slate-600 z-40";
export const sidebarToggleBtn = "bg-slate-100 hover:bg-slate-200 text-slate-700 text-sm font-bold px-3 py-2 rounded-md transition cursor-pointer border-2 border-slate-200 flex items-center space-x-1.5";
 
// Page tabs & buttons
export const pageTabsBar = "bg-slate-100 border-b border-slate-200 px-4 py-1.5 flex items-center space-x-2 text-sm print:hidden";
...
export const inputFieldStyle = "w-full  border-2 border-slate-200 rounded-lg px-3 py-1 text-sm text-slate-900 bg-white outline-none focus:border-blue-500 font-normal";
...
export const sidebarInstructionBox = "bg-slate-50 p-1 rounded-md border-2 border-slate-200 text-[11px] text-slate-500 space-y-1";
...
export const landingLogoImage = "w-16 h-16 object-cover rounded-2xl border-2 border-blue-200 shadow-xl";
export const landingBadge = "inline-block px-4 py-1.5 rounded-full bg-blue-950/80 border border-blue-500/30 text-blue-300 text-sm font-bold tracking-wider shadow-inner";
...
export const authLeftLogo = "w-10 h-10 object-cover rounded-md border-2 border-slate-200";
...
export const authBenefitIcon = "p-3 bg-blue-50 rounded-md text-blue-600 font-bold text-lg";
export const authBenefitTitle = "text-base font-bold text-slate-900";
export const authBenefitDesc = "text-slate-600 text-sm";
export const authRightContainer = "lg:w-1/2 p-8 lg:p-16 flex flex-col justify-center items-center";
export const authCardWrapper = "w-full max-w-md bg-white p-8 rounded-3xl border-2 border-slate-200 shadow-sm";
export const authCardTitle = "text-xl font-black text-slate-900 mb-2";
export const authCardDesc = "text-sm text-slate-500 mb-6";
export const authFormSpace = "space-y-4";
export const authInputLabel = "block text-sm font-bold text-slate-600 uppercase tracking-wider mb-2";
...
export const wizardSidebarLogo = "w-9 h-9 object-cover rounded-md border-2 border-slate-200";
...
export const wizardCardWrapper = "bg-white rounded-3xl p-8 lg:p-12 shadow-sm border-2 border-slate-200/80";
...
export const wizardStepDesc = "text-sm text-slate-500 font-medium";
export const wizardTwoColGrid = "grid grid-cols-1 sm:grid-cols-2 gap-6";
export const wizardInputLabel = "block text-sm font-bold text-slate-700 mb-1";
export const wizardIfscFlex = "flex space-x-2";
export const wizardIfscFetchBtn = "px-4 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-bold text-sm rounded-md shadow-xs transition cursor-pointer whitespace-nowrap";
...
export const wizardAgreementDesc = "text-sm text-slate-500 font-medium max-w-md mx-auto";
export const wizardFooterBar = "flex justify-between items-center mt-8 pt-4 border-t border-slate-200";
export const wizardProceedBtn = "px-6 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-md text-sm transition cursor-pointer shadow-sm";
// ==========================================
...
export const accountMainContainer = "mx-auto pb-14  flex-1 w-full bg-[#F2F5FA]";
export const footeraccountMainContainer = "mx-auto px-64   flex-1 w-full bg-[#F2F5FA]";
export const accountTitleSection = "text-center max-w-2xl mx-auto  ";
...
export const accountLabelStyle = "block text-sm font-semibold text-slate-700 mb-2.5";
export const accountRadioGroup = "flex items-center space-x-6 pt-1";
export const accountRadioLabel = "flex items-center space-x-2 text-sm font-semibold text-slate-700 cursor-pointer";
export const accountCheckboxWrapper = "flex items-center space-x-2.5 cursor-pointer";
export const accountNoticeBox = "bg-amber-50/80 border border-amber-200/80 text-amber-900 text-[11px] font-semibold px-4 py-2.5 rounded-md";


export const accountSecondaryBtn = "px-6 py-1.5 bg-white hover:bg-slate-50 text-slate-700 border border-slate-300 font-bold text-sm rounded-md transition cursor-pointer shadow-2xs";
export const accountPrimaryBtn = "px-6 py-1.5 bg-blue-600 hover:bg-blue-700 text-white font-bold text-sm rounded-lg transition cursor-pointer shadow-sm flex items-center space-x-1.5";
...
export const accountUploadContainer = "border-2 border-dashe2 border-blue-200 rounded-2xl p-6 bg-slate-50/50 flex flex-col items-center justify-center text-center";
...
export const accountUploadBtn = "px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-bold text-sm rounded-md transition cursor-pointer shadow-sm";
...
export const accountPreviewBox = "border-2 border-slate-200 rounded-2xl p-5 bg-slate-50/30 flex flex-col justify-between";
...
export const accountSampleCardWrapper = "bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-100 rounded-md p-3 inline-block shadow-2xs";
...
export const gstModalBody = "overflow-y-auto space-y-2 text-sm text-slate-600 font-medium leading-relaxed pr-2 border-2 border-slate-200 bg-slate-50/40 p-2 rounded-md flex-1 my-3";
...
export const gstModalProceedBtn = "px-6 py-1.5 bg-blue-600 text-white font-bold text-sm rounded-md transition cursor-pointer shadow-sm disabled:bg-slate-200 disabled:text-slate-400 disabled:cursor-not-allowed";


export const gstDeclarationList = "list-decimal pl-5 space-y-2 text-justify";
// Add or update this inside your MasterCSSClass.js
export const gstDeclarationContainer = "space-y-4 text-sm text-slate-700 font-medium leading-relaxed text-justify font-sans";
...
export const sigModalSubTitle = "text-sm text-slate-500";
export const sigCanvasBox = "w-full h-48 border border-slate-300 rounded-md bg-white touch-none shadow-inner";
export const sigNoticeBox = "flex items-center gap-2 p-1.5 bg-blue-50/60 border border-blue-100 rounded-md text-[11px] text-slate-600";
export const sigModalFooter = "flex items-center justify-between pt-3 border-t border-slate-100";
export const sigCancelBtn = "px-4 py-2 text-sm font-bold text-slate-600 hover:bg-slate-100 rounded-md transition cursor-pointer border-2 border-slate-200";
export const sigClearBtn = "px-4 py-2 text-sm font-bold text-slate-600 hover:bg-slate-100 rounded-md transition cursor-pointer border-2 border-slate-200";
export const sigSaveBtn = "px-5 py-2 text-sm font-bold text-white bg-blue-600 hover:bg-blue-700 rounded-md transition shadow-sm cursor-pointer";

// Signature Preview Box on Step 3
export const sigActionBox = "flex flex-col items-center justify-center border border-dashed border-slate-300 rounded-md p-4 bg-slate-50/50 space-y-2";
export const sigCreateBtn = "px-5 py-2 bg-blue-600 text-white font-bold text-sm rounded-lg hover:bg-blue-700 transition shadow-sm cursor-pointer";
...
export const sigImageCard = "w-full h-24 border border-slate-300 rounded-md bg-white flex items-center justify-center p-2 shadow-inner overflow-hidden";
...
export const sigLabelText = "text-sm font-semibold text-slate-800";
...
export const signatureEmptyBox = "flex flex-col items-center justify-center rounded-md p-4 space-y-2 w-[240px]";
...
export const imgModalTitle = "text-sm font-bold text-slate-800";
export const imgModalCloseBtn = "w-7 h-7 flex items-center justify-center rounded-full bg-slate-100 text-slate-600 hover:bg-slate-200 text-sm font-bold transition cursor-pointer";
export const imgModalBody = "text-center";
export const imgModalImage = "max-h-[70vh] w-auto mx-auto rounded-md object-contain shadow-sm";
...
export const dashTopNavbar = "h-14 bg-white px-6 lg:px-6 border-b border-slate-200 flex items-center justify-between sticky top-0 z-50 shadow-xs w-full shrink-0";
...
export const dashTopSubDateText = "text-sm font-medium text-slate-400";
...
export const dashBrandLogo = "w-9 h-9 object-cover rounded-md shrink-0";
...
export const dashFooterArea = "shrink-0 z-30 bg-white border-t border-slate-200 h-14 px-8 flex items-center justify-end text-sm text-slate-400 font-medium";
...
export const dashAddEventCard = "lg:col-span-4 rounded-md p-6  shadow-xs flex flex-col justify-between";
export const dashAddEventHeader = "space-y-1";
export const dashAddEventTitle = "text-lg font-semibold text-slate-900";
export const dashAddEventSub = "text-sm text-slate-400 font-medium leading-relaxed";
export const dashCreateEventBtn = "inline-flex items-center justify-center space-x-2 px-5 py-2.5  text-blue-600 font-bold text-sm rounded-md shadow-md shadow-blue-600/20 transition cursor-pointer mt-4";

export const dashActiveEventCardBox = "lg:col-span-8 grid grid-cols-1 sm:grid-cols-3 gap-4";
export const dashMiniEventCard = "bg-white rounded-md p-5 border border-slate-300 shadow-xs flex flex-col justify-between relative overflow-hidden group hover:border-blue-300 transition";
export const dashMiniEventHeaderRow = "flex items-center space-x-3 mb-3";
export const dashMiniEventThumb = "w-10 h-10 rounded-md object-cover shrink-0 border border-slate-100";
export const dashMiniEventInfo = "min-w-0";
export const dashMiniEventName = "text-sm font-bold text-slate-900 truncate";
...
export const dashStatCard = "bg-white rounded-md p-6 border-2 border-slate2300 shadow-xs flex flex-col justify-between";
export const dashStatCardHeaderRow = "flex items-center justify-between mb-4";
export const dashStatCardTitleBox = "flex items-center space-x-2 text-sm font-bold text-slate-500 tracking-wider";
export const dashStatCardIconCircle = "w-7 h-7 rounded-lg bg-blue-50 text-blue-600 flex items-center justify-center text-sm";
export const dashStatDropdownBtn = "text-slate-400 hover:text-slate-600 text-sm font-medium flex items-center space-x-1 bg-slate-50 px-2.5 py-1 rounded-lg border-2 border-slate-200 cursor-pointer";
...
export const dashDonutCard = "lg:col-span-5 bg-white rounded-md p-6 border-2 border-slate2300 shadow-xs flex flex-col justify-between";
...
export const dashLegendItemRow = "flex items-center space-x-2 text-sm font-medium text-slate-600";
...
export const dashBarChartCard = "lg:col-span-7 bg-white rounded-md p-6 border-2 border-slate2300 shadow-xs flex flex-col justify-between";
...
export const dashBarChartLegendRow = "flex flex-wrap items-center justify-center gap-6 pt-4 text-sm font-semibold text-slate-600";

export const dashBuyersListCard = "bg-white rounded-md p-6 border-2 border-slate2300 shadow-xs space-y-6";
...
export const dashSearchInputBox = "w-full sm:w-64 bg-slate-50 border-2 border-slate-200 rounded-md px-3.5 py-2 text-sm font-medium text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500";
export const dashFilterDropdownBtn = "flex items-center space-x-2 bg-slate-50 hover:bg-slate-100 text-slate-700 text-sm font-semibold px-3.5 py-2 rounded-md border-2 border-slate-200 transition cursor-pointer";
...
export const dashTableHeadTh = "pb-3 font-semibold px-3 first:pl-0 last:pr-0";
export const dashTableBodyRow = "border-b border-slate-100 hover:bg-slate-50/80 transition text-slate-700 font-semibold";
export const dashTableBodyTd = "py-4 px-3 font-semibold first:pl-0 last:pr-0";
...
export const dashTableFooterRow = "flex flex-col sm:flex-row items-center justify-between pt-2 text-sm text-slate-400 font-medium gap-3";
export const dashPaginationBox = "flex items-center space-x-1.5";
export const dashPaginationNumActive = "w-7 h-7 rounded-lg bg-blue-600 text-white font-bold flex items-center justify-center text-sm";
export const dashPaginationNumInactive = "w-7 h-7 rounded-lg hover:bg-slate-100 text-slate-600 font-bold flex items-center justify-center text-sm cursor-pointer";
...
export const dashWalletTitleText = "text-sm font-semibold text-blue-200 tracking-wider uppercase mb-1";
...
export const dashCalendarHeaderTitle = "text-sm font-bold text-slate-400 uppercase tracking-widest";
export const dashCalendarDateSubText = "text-sm font-semibold text-slate-900";
export const dashScheduleEventItemCard = "p-3 rounded-md border border-slate-100 bg-slate-50/70 hover:bg-slate-50 transition space-y-1";
export const dashScheduleEventTime = "text-[10px] font-bold text-blue-600";
export const dashScheduleEventName = "text-sm font-extrabold text-slate-900";
...
export const dashSidebarBlueStrip = "w-14 bg-blue-600 flex flex-col items-center justify-between py-4 shrink-0 z-10 text-white";
export const dashSidebarBlueIconsTop = "flex flex-col items-center space-y-4";
export const dashSidebarBlueIconsBottom = "flex flex-col items-center space-y-4";
export const dashBlueIconButton = "p-2 rounded-md hover:bg-blue-700 transition cursor-pointer text-white/80 hover:text-white";
export const dashBlueIconButtonActive = "p-2 rounded-md bg-blue-700 text-white shadow-sm";
...
export const paychequeBalanceCard = "bg-blue-50/40 rounded-md border border-blue-100 p-6 flex flex-col justify-between shadow-xs";
export const paychequeCardHeader = "flex items-center space-x-1.5 mb-1";
export const paychequeCardLabel = "text-sm font-bold text-slate-500";
export const paychequeHelpIcon = "text-slate-400 cursor-pointer text-sm";
...
export const paychequeViewTxLink = "text-sm underline font-bold text-blue-600 hover:text-blue-700 cursor-pointer";

export const paychequeStandardCard = "bg-white rounded-md border-2 border-slate-200 p-6 flex flex-col justify-between shadow-xs";
export const paychequeCardFooterWhite = "mt-4 pt-3 border-t border-slate-100";
export const paychequeRequestBtn = "px-4 py-2 bg-slate-800 hover:bg-slate-900 text-white font-bold text-sm rounded-none transition";
...
export const paychequeTransactionSection = "bg-white rounded-none border-2 border-slate-200 p-6 space-y-6 shadow-xs";
...
export const paychequeTabsGroup = "flex space-x-6 text-sm font-bold pt-2";
...
export const paychequeUpdateText = "text-sm text-slate-400 font-medium flex items-center space-x-2";
...
export const paychequeSearchInput = "w-full bg-white border-2 border-slate-200 rounded-none px-8 py-2 text-sm text-slate-800 focus:outline-none focus:ring-1 focus:ring-blue-500";
export const paychequeSearchIcon = "absolute left-3 top-2.5 text-slate-400";
export const paychequeDropdownBtn = "bg-white border-2 border-slate-200 px-4 py-2 text-sm font-semibold text-slate-700 flex items-center space-x-4 rounded-none cursor-pointer";
export const paychequeDropdownMenu = "absolute left-0 mt-1 w-40 bg-white border-2 border-slate-200 shadow-lg z-20 rounded-none py-1";
export const paychequeDropdownMenuRight = "absolute right-0 mt-1 w-52 bg-white border-2 border-slate-200 shadow-lg z-20 rounded-none py-1 max-h-56 overflow-y-auto";
export const paychequeDropdownItem = "w-full text-left px-4 py-2 text-sm text-slate-700 hover:bg-slate-50 font-medium";

export const paychequeTableWrapper = "overflow-x-auto";
export const paychequeTable = "w-full text-left border-collapse text-sm whitespace-nowrap";
...
export const paychequeEmptyTd = "py-8 text-center text-slate-400 text-sm";

export const paychequeTableFooter = "flex flex-col sm:flex-row items-center justify-between   text-sm text-slate-400 font-medium gap-2";
export const paychequePaginationGroup = "flex items-center space-x-1";
export const paychequePageBtn = "w-7 h-7 rounded-none border-2 border-slate-200 text-slate-400 flex items-center justify-center text-sm";
export const paychequePageBtnActive = "w-7 h-7 rounded-none bg-blue-600 text-white font-bold flex items-center justify-center text-sm";

export const paychequeBottomActionsRow = "flex flex-wrap items-center gap-3 pt-2";
export const paychequeBottomDropdownMenu = "absolute left-0 mt-1 w-52 bg-white border-2 border-slate-200 shadow-lg z-40 rounded-none py-1 max-h-56 overflow-y-auto";
...
export const reportFilterRow = "flex flex-wrap items-center justify-between gap-4  py-1  rounded-md   shadow-xs mb-1";
export const reportFilterGroup = "flex flex-wrap items-center gap-3";
export const reportDropdownButton = "bg-white border border-slate-200 py-1 px-2 text-sm font-semibold  flex items-center justify-between space-x-6 rounded-md shadow-xs cursor-pointer";


export const reportMetricsGrid = "grid grid-cols-1  sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6";
export const reportMetricCard = "bg-white rounded-md border-2  border-slate-200 p-6 flex flex-col items-center justify-center text-center shadow-xs";
export const reportMetricValue = "text-2xl font-black text-slate-900 tracking-tight mt-1";
export const reportMetricLabel = "text-sm font-bold text-slate-400 uppercase tracking-wider";

export const reportSectionCard = "rounded-md bg-white border-2 border-slate-200 p-6 shadow-xs space-y-4 mb-6";
export const reportSectionTitle = "text-sm font-extrabold text-slate-900";
export const reportTable = "w-full text-left border-collapse text-sm whitespace-nowrap";
...
export const reportLegendList = "space-y-2 pt-2 border-t border-slate-100 text-sm";


// Replace/Update these in MasterCSSClass.js
export const reportRefreshBtn = "p-2 bg-white hover:bg-slate-50 text-slate-600 text-sm font-bold cursor-pointer";
export const reportChartCard = " rounded-md bg-white border-2 border-slate-200 p-6 shadow-xs flex flex-col justify-between";
...
export const reportLegendListHorizontal = "space-y-2 text-sm flex-col justify-center";
...
export const modalPhotoDropBox = "w-20 h-20 rounded-full border-2 border-slate2300 flex flex-col items-center justify-center cursor-pointer overflow-hidden bg-slate-50 hover:bg-slate-100 transition relative group shadow-xs";
