...
export const inputFieldStyle = "w-full  border-2 border-slate-200 rounded-lg px-3 py-2 text-sm text-slate-900 outline-none focus:border-blue-500 font-normal";
